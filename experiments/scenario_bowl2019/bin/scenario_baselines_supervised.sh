...
python -m ptls.pl_train_module --conf conf/cpc_params_for_finetuning.hocon
...
python -m ptls.pl_fit_target data_module.train.drop_last=true --conf conf/pl_fit_finetuning_rtd.hocon

cp "../../artifacts/scenario_bowl2019/barlow_twins_model.p" "../../artifacts/scenario_bowl2019/barlow_twins_model_ft.p"
# Fine tune the RTD model in supervised mode and save scores to the file
python -m ptls.pl_fit_target data_module.train.drop_last=true --conf conf/pl_fit_finetuning_barlow_twins.hocon
