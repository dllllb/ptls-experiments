# mles
checkpoints_folder="lightning_logs/mles_l_model/version_0/checkpoints/*.ckpt"
output_file_prefix="mles_l__"
conf_file="mles_l_params"
batch_size=1000
...
rm results/epochs_mles_l.txt
# rm -r conf/embeddings_validation.work/
python -m embeddings_validation \
    --config-dir conf --config-name embeddings_validation_short +workers=10 +total_cpu_count=20 \
    report_file="results/epochs_mles_l.txt" \
    +auto_features=["data/mles_l__???.pickle"]
