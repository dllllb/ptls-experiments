...
python -m ptls.pl_train_module --config-dir conf --config-name mles_params trainer.max_epochs=3
...
# Train the Contrastive Predictive Coding (CPC) model; inference
python -m ptls.pl_train_module --config-dir conf --config-name barlow_twins_params trainer.max_epochs=3
