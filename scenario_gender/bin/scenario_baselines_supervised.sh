...
python -m ptls.pl_fit_target --config-dir conf --config-name pl_fit_finetuning_mles trainer.max_epochs=3

# Fine tune the CPC model in supervised mode and save scores to the file
python -m ptls.pl_fit_target --config-dir conf --config-name pl_fit_finetuning_cpc trainer.max_epochs=3

# Fine tune the RTD model in supervised mode and save scores to the file
python -m ptls.pl_fit_target --config-dir conf --config-name pl_fit_finetuning_rtd trainer.max_epochs=3
...
# Fine tune the RTD model in supervised mode and save scores to the file
python -m ptls.pl_fit_target --config-dir conf --config-name pl_fit_finetuning_barlow_twins trainer.max_epochs=3
